...
import { FaSoundcloud, FaSpotify } from "react-icons/fa6";

export default function Soundcloud() {
  return (
    <div className="w-full">
      <TitleCategory classtitle={""} icon={<FaSoundcloud size={23} />}>
        Top On Soundcloud Malawi
      </TitleCategory>
      <SongTabList />
    </div>
  );
